...
def create_model(
    ...
    **extra_options,
    ...
    elif config.architectures[0] == "SarvamMoEForCausalLM":
        print("WARNING: MoE is only supported for CUDA in ONNX Runtime.")
        onnx_model = SarvamModel(config, io_dtype, onnx_dtype, execution_provider, cache_dir, extra_options)

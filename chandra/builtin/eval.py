"""Evaluate quantized ONNX vs PyTorch datalab-to/chandra on AI2D (diagram understanding).
...
Usage:
    ...
    python eval.py --pytorch_model datalab-to/chandra

    # Larger sample
    python eval.py --num_samples 200 --pytorch_model datalab-to/chandra
"""

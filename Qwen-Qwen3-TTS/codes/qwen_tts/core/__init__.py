...
# NOTE: 25Hz tokenizer trimmed — it pulls an optional `sox` dependency and is
# unused for the 12Hz pipeline we export.
try:
    ...
    Qwen3TTSTokenizerV1Config = Qwen3TTSTokenizerV1Model = None

"""End-to-end optimization pipeline for datalab-to/chandra ONNX models.
...
def update_genai_config(output_dir: str = MODELS_DIR, device: str = "gpu"):
    ...
    # Chandra preprocessor_config.json:
    #   size.shortest_edge = 65536  -> min_pixels
    #   size.longest_edge  = 16777216 -> max_pixels
...
def main():
    parser = argparse.ArgumentParser(description="Optimize datalab-to/chandra ONNX models")

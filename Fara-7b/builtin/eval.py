"""Evaluate quantized ONNX vs PyTorch microsoft/Fara-7B on AI2D (diagram understanding).
...
Usage:
    ...
    python eval.py --pytorch_model microsoft/Fara-7B

    # Larger sample
    python eval.py --num_samples 200 --pytorch_model microsoft/Fara-7B
"""
...
def main():
    parser = argparse.ArgumentParser(description="Eval ONNX (quantized) vs PyTorch microsoft/Fara-7B on AI2D")
    ...
    parser.add_argument("--pytorch_model", default=None,
                        help="HuggingFace model ID for PyTorch comparison, e.g. microsoft/Fara-7B")
